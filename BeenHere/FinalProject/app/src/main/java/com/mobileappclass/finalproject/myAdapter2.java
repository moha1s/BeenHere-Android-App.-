...
public class myAdapter2 extends BaseAdapter {
    ...
    public myAdapter2(ArrayList<Record> list, Context context) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.title = (TextView) convertView.findViewById(R.id.user_name2);
            holder.content= (TextView) convertView.findViewById(R.id.user_content2);
